...
public class Transcation {
	...
	public static void main(String[] args) {
		...
		List<Transcation> list=Arrays.asList(
				new Transcation(new Trader("Iron Man", "Pune"), 2011, 5000),
				new Transcation(new Trader("Thor", "Bangalore"), 2012, 4000),
				new Transcation(new Trader("Hulk", "Pune"), 2011, 3000),
				new Transcation(new Trader("Captain", "Delhi"), 2012, 2000)
				);
